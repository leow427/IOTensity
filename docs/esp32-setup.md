...
6. In **Sync**, choose **Synthetic color simulation** and Start. The physical LED and its preview receive the same final RGB values. For a static test choose **Deterministic test image**; screen capture remains macOS-only.
